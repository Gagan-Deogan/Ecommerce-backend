...
const updateWishlist = (wishlist, product) =>{
  const updatedProducts = concat(wishlist.products, {_id:product._id ,product:product._id})
...
module.exports ={ isAlreadyInWishlist, updateWishlist, extractProductfromProducts }